...
export default function Home() {
  return (
    <div className="w-full p-5 bg-[#FEFEFE] bg-red-500s h-screen">
      <div className="flex items-center justify-between">
        ...
        <Link href={"/atlys-auth"}>
          <picture className="flex items-center transition ease-in-out delay-150 hover:translate-y-0.5 hover:scale-80  duration-300 gap-2 cursor-pointer">
